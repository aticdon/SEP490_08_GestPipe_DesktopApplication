...
//            {
//                Size = new Size(60, 60),
//                // SỬA LẠI: Tự động canh giữa icon theo pnlCard.Width
//                Location = new Point((pnlCard.Width - 60) / 2, 30), // (430 - 60) / 2 = 185
...
//                // SỬA LẠI: Cho Label rộng bằng pnlCard để tự canh giữa text
//                Size = new Size(pnlCard.Width, 35),
//                BackColor = Color.Transparent,
...
//                // SỬA LẠI: Canh lề 2 bên 40px (giống ban đầu)
//                Location = new Point(40, 145),
//                Size = new Size(pnlCard.Width - 80, 60), // (430 - 80 = 350)
//                BackColor = Color.Transparent,
...
//            {
//                // SỬA LẠI: Cho Panel rộng bằng pnlCard
//                Size = new Size(pnlCard.Width, 50), // <-- Sửa từ 480 thành pnlCard.Width
//                Location = new Point(0, 215),
//                BackColor = Color.Transparent
//            };
//            pnlCard.Controls.Add(pnlButtons);

//            AddButtons(pnlButtons); // Gọi AddButtons với panel đã có size 430

//            // ✅ Close button (X)
//            var btnClose = new Guna2CircleButton
//            {
//                Size = new Size(30, 30),
//                // SỬA LẠI: Tự động đặt bên phải, cách lề 10px
//                Location = new Point(pnlCard.Width - 40, 10), // (430 - 30 (width) - 10 (margin))
//                Text = "✕",
...
//            // Lấy chiều rộng thực tế của panel (là 430) để tính toán
//            int panelWidth = pnlButtons.Width;

//            switch (_buttons)
//            {
//                case MessageBoxButtons.OK:
//                    // SỬA LẠI: Dùng panelWidth thay vì 480
//                    AddGradientButton(pnlButtons, "OK", (panelWidth - btnWidth) / 2, 5, DialogResult.OK, true);
//                    break;
...
namespace GestPipePowerPonit.Views
{
    public partial class CustomMessageBox : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(8F, 16F);
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None; // ✅ THAY ĐỔI
