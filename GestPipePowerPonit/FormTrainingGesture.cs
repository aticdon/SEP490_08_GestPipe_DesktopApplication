...
namespace GestPipePowerPonit
{
    public partial class FormTrainingGesture : Form
    {
        ...
        public string _currentUserId = "68fa3209582c17a482c5b11e";
        ...
        private async void SaveTrainingResultToDb()
        {
            ...
            try
            {
                ...
                MessageBox.Show(ok ? "Lưu thành công" : "Lỗi lưu dữ liệu!");
            }
            catch (Exception ex)
            {
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            ...
            var resultForm = new FormTrainingResult(gestureName, poseLabel, accuracy, trainingDay);
            resultForm.Show();
            //if (_userGestureForm == null || _userGestureForm.IsDisposed)
            //{
            //    _userGestureForm = new FormUserGesture(_homeForm, _currentUserId); // nhớ truyền tham số đúng
            //}
